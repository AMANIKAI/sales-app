                   ...
                   <div className="row">
                       ...
                       <div className="col-md-4">
                           ...
                           <div className="yolomy-div">
                               <div className="yolomy">LUX-AMANI</div>
                               <p className="yolomy-desc">
                                   WE UNDERSTAND LUXURY IN STYLE <br />
                                   WE UNDERSTAND COMFORT AND CONVENIENCE <br />
                                   WHERE EXECUTIVE STANDARDS MEET AFFORDABILITY. <br />
                               </p>
                           </div>
                       ...
                       <div className="col-md-4">
                           <div className="footer-links-slogan float-md-right">
                               ...
                               <div className="slogan yolomy">
                                   LUX-AMANI: We Mean Great Luxury
                               </div>
                           </div>
                       ...
                       <div className="col-12">
                           <p className="text-center copyrights">COPYRIGHTS, LUX-AMANI INC @2023</p>
                       </div>
                   </div>
               </div>
